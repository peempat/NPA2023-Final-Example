...
roomIdToGetMessages = "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vNTAyYTJhZDAtNTc0Ny0xMWVmLWJhMDctODUyMDlkZGZiNmZj" 
...
# 8. Prepare openweatherAPIGetParameters for OpenWeather API, https://openweathermap.org/api; current weather data for one location by geographic coordinates.
        ...
        openweatherAPIGetParameters = {
                                ...
                                'lon' : locationLng,
                                'appid' : "0d6b7ff9f1706930f73f5df87e26121c",
                                'units' : "metric" #โจทย์บอกอยากได้ temp เป็น celcieus
                            }
